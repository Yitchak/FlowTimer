      ...
      <AnimatePresence mode="wait">
        {isEditorOpen ? (
          ...
          >
            ...
            <div
              className="pr-8 overflow-x-auto no-scrollbar flex flex-nowrap items-center gap-3 mb-0 w-full border-b border-black/5 dark:border-white/5 shadow-sm pl-4 md:pl-16 pt-6 pb-6 md:pt-[60px] md:pb-8"
              style={{
                display: 'flex',
